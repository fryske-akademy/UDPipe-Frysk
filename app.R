  ...
  (
    ...
    (
      ...
      (
        ...
        h5(strong("About")),
        p("UDPipe Frysk is a web app for lemmatizing, PoS tagging and dependency parsing of Frisian texts. The lemmatizer/tagger/parser are trained on Frisian text that is annotated according to the ", a("guidelines of Universal Dependencies version 2", href = "https://universaldependencies.org/guidelines.html", target = "_blank"), ". We use", a("UDPipe", href = "http://dx.doi.org/10.18653/v1/K17-3009", target = "_blank"), "as available via the R package", a("udpipe", href = "https://cran.r-project.org/web/packages/udpipe/index.html", target = "_blank"), ". The following people were involved in the development of UDPipe Frysk: Wilbert Heeringa (Fryske Akademy, building training corpus/implementation web app/command line script), Gosse Bouma (University of Groningen, advice), Martha Hofman (Fryske Akademy, building training corpus), Eduard Drenth (Fryske Akademy, building web service), Fenna Bergsma (Fryske Akademy, advice), Hans Van de Velde (Fryske Akademy, project manager). UDPipe Frysk is still under develoment. Comments are welcome and can be sent to", img(src = 'email.png', height = 19, align = "center"),"."),
        ...
        p("Wilbert Heeringa, Gosse Bouma, Martha Hofman, Eduard Drenth, Jan Wijffels & Hans Van de Velde (2022),", a("POS tagging, lemmatization and dependency parsing of West Frisian", href = "https://aclanthology.org/2022.lrec-1.512/", target = "_blank"), HTML(". In <i>Proceedings of the Thirteenth Language Resources and Evaluation Conference</i>, pages 4789–4798, Marseille, France. European Language Resources Association.")),
        br(),
